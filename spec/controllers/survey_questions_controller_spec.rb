...
describe Api::V1::SurveyQuestionsController do
  ...
  it "returns a MultipleResponseQuestion" do
    user = create(:user)
    ...
    survey_question = SurveyQuestionRepresenter.new.extend(Api::V1::MultipleResponseQuestionRepresenter).from_json(response.body)
  ...
  it "returns a range question" do
    ...
    survey_question = SurveyQuestionRepresenter.new.extend(Api::V1::RangeQuestionRepresenter).from_json(response.body)
